// GENERATED AUTOMATICALLY FROM 'Assets/DogPlayerControls.inputactions'
...
public class @DogPlayerControls : IInputActionCollection, IDisposable
{
    public InputActionAsset asset { get; }
    public @DogPlayerControls()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""DogPlayerControls"",
    ""maps"": [
        {
    ...
    {
        private @DogPlayerControls m_Wrapper;
        public DogPlayerControlsActions(@DogPlayerControls wrapper) { m_Wrapper = wrapper; }
    ...
    public DogPlayerControlsActions @PlayerControls => new DogPlayerControlsActions(this);
    ...
    {
        private @DogPlayerControls m_Wrapper;
        public BoomerangPlayerControlsActions(@DogPlayerControls wrapper) { m_Wrapper = wrapper; }
